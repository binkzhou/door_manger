    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="reward_name" label="打赏人昵称" width="300"></el-table-column>
                <el-table-column prop="reward_amount" label="金额"></el-table-column>
                <el-table-column prop="reward_createDate" label="打赏时间"></el-table-column>
                <el-table-column prop="reward_state" label="状态"></el-table-column>
                <el-table-column prop="reward_content" label="留言"></el-table-column>
...
export default {
    ...
    setup() {
        ...
        // 获取表格数据
        const getData = () => {
            fetchRewards(page.pageNum-1,page.maxPage,{...query,name:encodeURIComponent(query.name)}).then((res) => {
                console.log('res.list',res.data);
                const data = res.data;
                tableData.value = data.rewardList;
